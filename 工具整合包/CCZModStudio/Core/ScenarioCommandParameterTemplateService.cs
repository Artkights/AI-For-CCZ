    ...
    private static IReadOnlyDictionary<int, CommandTemplate> BuildTemplates()
    {
        var templates = new List<CommandTemplate>
        {
            ...
            T(0x46, "友军出场设定", "用于设置友军单位是否出场、位置或状态。",
                ...
                S(1, "隐藏", SlotKind.BooleanFlag, "0=正常显示，1=隐藏出场；地图预览按该槽显示半透明/隐标记。"),
                S(2, "X坐标", SlotKind.CoordinateX, "出场 X 坐标候选。"),
                S(3, "Y坐标", SlotKind.CoordinateY, "出场 Y 坐标候选。"),
                S(4, "朝向", SlotKind.Direction, "0=上，1=右，2=下，3=左。"),
                S(5, "等级加成", SlotKind.Count, "相对等级修正，直接进入战场预览和状态写回。"),
                S(6, "兵种级", SlotKind.Value, "0=初级，1=中级，2=高级。"),
                S(7, "AI", SlotKind.AiPolicy, "0=被动，1=主动，2=坚守，3=攻击，4=到点，5=跟随，6=逃离。"),
                S(8, "目标武将", SlotKind.Person, "AI 目标人物 Person2 编码。"),
                S(9, "目标X", SlotKind.CoordinateX, "AI 目标 X 坐标。"),
                S(10, "目标Y", SlotKind.CoordinateY, "AI 目标 Y 坐标。")),

            T(0x47, "敌军出场设定", "用于设置敌军单位是否出场、位置或状态。",
                "敌军出场会影响难度和胜败条件，改动后应完整战斗测试。",
                S(0, "敌军人物/部队", SlotKind.Person, "敌军人物或部队候选。"),
                S(1, "援军", SlotKind.BooleanFlag, "0=普通敌军，1=援军；该槽独立于隐藏。"),
                S(2, "隐藏", SlotKind.BooleanFlag, "0=正常显示，1=隐藏出场；地图预览按该槽显示半透明/隐标记。"),
                S(3, "X坐标", SlotKind.CoordinateX, "出场 X 坐标候选。"),
                S(4, "Y坐标", SlotKind.CoordinateY, "出场 Y 坐标候选。"),
                S(5, "朝向", SlotKind.Direction, "0=上，1=右，2=下，3=左。"),
                S(6, "等级加成", SlotKind.Count, "相对等级修正，直接进入战场预览和状态写回。"),
                S(7, "兵种级", SlotKind.Value, "0=初级，1=中级，2=高级。"),
                S(8, "AI", SlotKind.AiPolicy, "0=被动，1=主动，2=坚守，3=攻击，4=到点，5=跟随，6=逃离。"),
                S(9, "目标武将", SlotKind.Person, "AI 目标人物 Person2 编码。"),
                S(10, "目标X", SlotKind.CoordinateX, "AI 目标 X 坐标。"),
                S(11, "目标Y", SlotKind.CoordinateY, "AI 目标 Y 坐标。")),
            ...
            T(0x48, "战场装备设定", "用于设置 46/47 部署段中友军或敌军单位的武器、防具和辅助装备。",
                ...
                S(5, "辅助编码", SlotKind.Value, "辅助装备段内相对装备编码：0=默认，1=卸去，2+=AssID..255 内相对编号+2；该编码不重排，消耗品不是可装备辅助。")),
            ...
            T(0x4A, "我军出场强制设定", "用于强制指定我军人物出场或禁止离队。",
                ...
                S(0, "数量/位置", SlotKind.Count, "旧 Dialog_6 中的数值槽；后续 10 槽为 Per1 人物编码。"),
                S(1, "强制出场1", SlotKind.Person, "Per1 人物编码；-1=无，0=人物 0。"),
                S(2, "强制出场2", SlotKind.Person, "Per1 人物编码；-1=无，0=人物 0。"),
                S(3, "强制出场3", SlotKind.Person, "Per1 人物编码；-1=无，0=人物 0。"),
                S(4, "强制出场4", SlotKind.Person, "Per1 人物编码；-1=无，0=人物 0。"),
                S(5, "强制出场5", SlotKind.Person, "Per1 人物编码；-1=无，0=人物 0。"),
                S(6, "强制不出场1", SlotKind.Person, "Per1 人物编码；-1=无，0=人物 0。"),
                S(7, "强制不出场2", SlotKind.Person, "Per1 人物编码；-1=无，0=人物 0。"),
                S(8, "强制不出场3", SlotKind.Person, "Per1 人物编码；-1=无，0=人物 0。"),
                S(9, "强制不出场4", SlotKind.Person, "Per1 人物编码；-1=无，0=人物 0。"),
                S(10, "强制不出场5", SlotKind.Person, "Per1 人物编码；-1=无，0=人物 0。")),

            T(0x4B, "我军出场设定", "用于设置我军人物出场、隐藏或可选状态。",
                "该命令与出场限制、强制出场类似，需按战前选择实机验证。",
                S(0, "出战顺序", SlotKind.Count, "我军战前出战顺序，从 0 开始；写回地图坐标时不改该槽。"),
                S(1, "X坐标", SlotKind.CoordinateX, "候选出战位 X 坐标。"),
                S(2, "Y坐标", SlotKind.CoordinateY, "候选出战位 Y 坐标。"),
                S(3, "朝向", SlotKind.Direction, "0=上，1=右，2=下，3=左。"),
                S(4, "隐藏", SlotKind.BooleanFlag, "0=正常，1=隐藏出战位。")),
