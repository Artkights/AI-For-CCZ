...
0x42518F (包装函数)
    ...
    └── 验证失败 → call 0x41301E (fallback: 仅双渠道判定)
游戏逻辑层 (使用返回值)
```

#### 相关文档

- [桩函数格式](./stub-function.md) - 了解桩函数的参数传递规范
- [特效值机制](../03-机制详解/effect-value.md) - 深入理解效果值的传递和使用
